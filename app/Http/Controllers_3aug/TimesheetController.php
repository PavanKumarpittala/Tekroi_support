...
class TimesheetController extends Controller
{
    ...
    {
      $projects = DB::table('projects')->select('project_name','id')
    ...
    $data = $request->all();
     ...
     for ($i=0; $i < count($data['date']); $i++) { 
      ...
      $params = array(
       ...
       if($details)
      {
        return Response::json(array('success'=>1,'message'=>'Timesheet Details Added Successfully.'));

      }else{
        return Response::json(array('success'=>0,'message'=>'Timesheet Details Not Added.'));

...
.card-header {
  background-color:#6EEA12 !important;
}
...
<main class="app-content">
  <div class="container-fluid">
      <div class="col-md-12 user-right">
          <!-- <div class="row">
             <div class="col-md-12">
              <h3 class="tile-title text-success">{{$ticket_data->subject_ticketid}}</h3>
            </div> 
          </div> -->
                ...
                <div class="card-header">
                   <div class="row">
                      ...
                      <div class="col-md-4 pull-right">
                       <h5 class="tile-title text-white"><b>Posted On: </b>{{$ticket_data->created_at}}</h5>
                      </div>
                    </div>
                 </div>
                <div class="card-body">
                  <div class="row g-0">
                     <div class="col-md-4">
                      ...
                      <div class="col-md-8">
                        <p>{{$ticket_data->ticket_summary}}</p>
                  ...
                  <div class="col-md-8 ">
                    @forelse ($last_ticket_replies as $ticket_reply)
                      <div class="card-body">
                          ...
                          <p class="card-text"><pre>{{ $ticket_reply->created_at }}</pre></p>
                          <h5 class="card-title"><b>Attachments</b></h5>
                         <p class="card-text">{{ $ticket_reply->attachments ?? 'Nill' }}</p>
                      @php
                      ...
                      <button type="button" class="btn btn-primary ml-2 view_more_btn mb-3 ml-3" name="submit">
                        View More
                      </button>
                       @empty
                       No replies.
       ...
       <!--    <div class="card mb-3 d-none all_tickets">
          ...
          <!-- <div class="row ticket-replies">
            ...
            @forelse ($ticket_replies as $ticket_reply)
                <div class="col-md-12">
                    <p> <b>Summary</b> : <pre>{{ $ticket_reply->summary }}</pre></p>
                    <p> <b>Received At</b> / Replied : {{ $ticket_reply->created_at }}</p>
                    <p> <b>Attachments</b> : {{ $ticket_reply->attachments ?? 'Nill' }}</p>

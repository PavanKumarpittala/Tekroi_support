         ...
         "order": [
          ...
          "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull) {
            ...
            action1 += '<a href='+view_customer+' title="View Customer"><i class="fa fa-eye" aria-hidden="true" style="font-size:22px;text-align:center;color:#c09500;cursor: pointer;"></i></a>&nbsp&nbsp';
             ...
             // action1 += '<a data-toggle="modal" data-target="#update_customers"  title="Edit" onclick="editCustomer('+aData['id']+');"><i class="fa fa-pencil-square-o" aria-hidden="true" style="font-size:22px;text-align:center;color:#c09500;cursor: pointer;"></i></a>&nbsp&nbsp';

             action1 += '</td>';
               

              $('td:eq(11)', nRow).html(action1); 

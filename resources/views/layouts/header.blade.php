  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="{{url('')}}"><img src="{{asset('images/tekroi-Logo.png')}}" style="width:197px;height:61px;background-color: #fff;"></a>
      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-user fa-lg"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            ...
            <li><a class="dropdown-item" href=""><i class="fa fa-user fa-lg"></i> <?php if (Auth::check()) { echo Auth::user()->name; }  ?></a></li>
            <li><a class="dropdown-item" href="{{ route('changePasswordGet') }}"><i class="fa fa-key" aria-hidden="true"></i>Change Password </a></li>
            <li>
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="{{asset('images/profile.jpg')}}" alt="User Image" style="width:40px;height:40px;">
        <div>
     ...
     @if(Auth::user()->role != 1 && Auth::user()->role != 4)
      ...
      @if(Auth::user()->role != 4)
       ...
       @if(Auth::user()->role != 2 && Auth::user()->role != 3 && Auth::user()->role != 4)
        ...
        <li class="treeview">
          <a class="app-menu__item" href="{{url('users_list')}}" data-toggle="treeview">
            <i class="app-menu__icon fa fa-users"></i>
            <span class="app-menu__label">Team</span>
            <i class="treeview-indicator fa fa-angle-right"></i>
          </a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="{{url('users_list')}}"><i class="icon fa fa-circle-o"></i>Team Members</a></li>
            <li><a class="treeview-item" href="{{url('user_assigned')}}"><i class="icon fa fa-circle-o"></i> Managing Team</a></li>
          </ul>
        </li>
        @endif
        @if(Auth::user()->role != 3 && Auth::user()->role != 4)
        ...
        @endif
         ...
         {{-- <li>
          <a class="app-menu__item" href="{{url('company_details')}}">
         ...
         @endif
         <li>
    <a class="app-menu__item" href="{{url('birthday')}}">
        <i class="app-menu__icon fa fa-birthday-cake"></i>
        <span class="app-menu__label">Birthday</span>
    </a>
</li>

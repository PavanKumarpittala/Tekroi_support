...
<div class="col-md-12 user-right">
   <div class="panel panel-default">
      ...
      <h4 style="color:#A04000">Email Feedback List</h4>
  ...
  var BranchListTable = $('#branch_table').DataTable({
        ...
        //  }
         ...
         "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull) {
            ...
            var action1 = '<a data-toggle="modal" data-target="#CustomerView" class="btn btn-primary" data-id="'+aData['id']+'" style="color: #fff;" onclick="appendUserId('+aData['id']+');">View Content</a>&nbsp&nbsp';
            ...
            var action2 = '<a data-toggle="modal" data-target="#status_update" class="btn btn-primary" data-id="'+aData['id']+'" style="color: #fff;" onclick="addDataValue('+aData['id']+');">Update Status</a>&nbsp&nbsp';
            action2 += '</td>';
             // $('td:eq(9)', nRow).html(action2);

             var action3 = '<a data-toggle="modal" data-target="#comments" class="btn btn-primary" data-id="'+aData['id']+'" style="color: #fff;" onclick="addDataValue('+aData['id']+');">Comments</a>&nbsp&nbsp';
            action3 += '</td>';
